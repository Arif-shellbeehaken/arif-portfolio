...
const HeroSection = () => {
  return (
    <section id="home">
      <div className="flex flex-col text-center items-center justify-center my-10 pt-16 md:flex-row md:space-x-4 md:text-left md:py-32 sm:py-32">
      ...
      <div className="pb-16">
        ...
        <p className="items-center justify-center flex">
          ...
          <span className="text-slate-500"> Git Contributon</span>{" "}
        </p>
      </div>
